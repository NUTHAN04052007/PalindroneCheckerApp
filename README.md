...
// Running Procedure: // 1. Open the project in any Java IDE (Eclipse, IntelliJ, VS Code) // OR use command prompt. // 2. Compile the file: // javac PalindroneCheckerApp.java // 3. Run the program: // java PalindroneCheckerApp // 4. The system will display a welcome message.

// Flow of Project: // Step 1: Application starts. // Step 2: Main method executes. // Step 3: Welcome message is displayed on the console. // Step 4: Program terminates.
